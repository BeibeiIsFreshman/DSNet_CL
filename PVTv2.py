...
def pvt_v2_b4(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = torch.load('/media/tbb/shuju/USOD/Backbone_pth/pvt_v2_b4.pth')
        print("加载成功")
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
...
def pvt_v2_b5(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = load_state_dict_from_url('https://github.com/whai362/PVT/releases/download/v2/pvt_v2_b5.pth', progress=True)
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
...
def pvt_v2_b2_li(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = load_state_dict_from_url('https://github.com/whai362/PVT/releases/download/v2/pvt_v2_b2_li.pth', progress=True)
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
...
if __name__ == '__main__':
    # pvt_v2_b0
    # /home/server/.cache/torch/hub/checkpoints/pvt_v2_b1.pth
    net = pvt_v2_b1(pretrained=True).cuda()
    # net.load_state_dict(torch.load('/home/server/.cache/torch/hub/checkpoints/pvt_v2_b2.pth'))
